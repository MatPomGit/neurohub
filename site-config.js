...
window.SITE_CONFIG = {
  ...
  plans: {
    ...
    psychometrics: [
      ...
      { file: 'wiki/psychometrics/rzetelnosc.md',   label: 'Rzetelność pomiaru',      status: 'planned' },
      { file: 'wiki/psychometrics/trafnosc.md',     label: 'Trafność pomiaru',        status: 'planned' },
      { file: 'wiki/psychometrics/normalizacja.md', label: 'Normalizacja i normy',    status: 'planned' },
      { file: 'wiki/psychometrics/teoria_ct.md',    label: 'Klasyczna teoria testu',  status: 'planned' },
      { file: 'wiki/psychometrics/irt.md',          label: 'IRT i model Rascha',      status: 'planned' },
      { file: 'wiki/psychometrics/cfa_efa.md',      label: 'Analiza czynnikowa',      status: 'planned' },
      { file: 'wiki/psychometrics/invariancja.md',  label: 'Inwariancja pomiarowa',   status: 'planned' },
    ],
    pharmacology: [
      { file: 'wiki/pharmacology/neurofarmakologia.md',   label: 'Neurofarmakologia',           status: 'live' },
      { file: 'wiki/pharmacology/przeciwdepresyjne.md',   label: 'Leki przeciwdepresyjne',      status: 'planned' },
      { file: 'wiki/pharmacology/przeciwpsychotyczne.md', label: 'Leki przeciwpsychotyczne',    status: 'planned' },
      { file: 'wiki/pharmacology/anxiolityki.md',         label: 'Anksjolityki i nasenne',      status: 'planned' },
      { file: 'wiki/pharmacology/stabilizatory.md',       label: 'Stabilizatory nastroju',      status: 'planned' },
      { file: 'wiki/pharmacology/uzaleznienia_farm.md',   label: 'Farmakoterapia uzależnień',   status: 'planned' },
    ...
    individual_diffs: [
      ...
      { file: 'wiki/individual_diffs/inteligencja.md',  label: 'Inteligencja',              status: 'planned' },
      { file: 'wiki/individual_diffs/osobowosc.md',     label: 'Osobowość (Wielka Piątka)', status: 'planned' },
      { file: 'wiki/individual_diffs/kreatywnosc.md',   label: 'Kreatywność',              status: 'planned' },
      { file: 'wiki/individual_diffs/genetyka.md',      label: 'Uwarunkowania genetyczne', status: 'planned' },
    ...
    temperament: [
      ...
      { file: 'wiki/temperament/modele.md',    label: 'Modele temperamentu',     status: 'planned' },
      { file: 'wiki/temperament/pomiar.md',    label: 'Pomiar temperamentu',     status: 'planned' },
      { file: 'wiki/temperament/kliniczne.md', label: 'Temperament w klinice',   status: 'planned' },
    ...
    emotions: [
      ...
      { file: 'wiki/emotions/teorie.md',       label: 'Teorie emocji',           status: 'planned' },
      { file: 'wiki/emotions/regulacja.md',    label: 'Regulacja emocjonalna',   status: 'planned' },
      { file: 'wiki/emotions/motywacja.md',    label: 'Motywacja',               status: 'planned' },
      { file: 'wiki/emotions/neurobiologia.md',label: 'Neurobiologia emocji',    status: 'planned' },
    ...
    biology: [
      ...
      { file: 'wiki/biology/genetyka_beh.md',    label: 'Genetyka behawioralna',      status: 'planned' },
      { file: 'wiki/biology/hormony.md',          label: 'Hormony i zachowanie',       status: 'planned' },
      { file: 'wiki/biology/ewolucja.md',         label: 'Ewolucja i psychologia ewol.',status: 'planned' },
      { file: 'wiki/biology/psychofizjologia.md', label: 'Psychofizjologia',           status: 'planned' },
    ...
    psychotherapy: [
      ...
      { file: 'wiki/psychotherapy/cbt.md',         label: 'Terapia poznawczo-beh. (CBT)', status: 'planned' },
      { file: 'wiki/psychotherapy/dbt.md',         label: 'Terapia dialektyczna (DBT)',    status: 'planned' },
      { file: 'wiki/psychotherapy/psychodyn.md',   label: 'Terapia psychodynamiczna',     status: 'planned' },
      { file: 'wiki/psychotherapy/humanist.md',    label: 'Podejście humanistyczne',      status: 'planned' },
      { file: 'wiki/psychotherapy/systemowa.md',   label: 'Terapia systemowa',            status: 'planned' },
      { file: 'wiki/psychotherapy/skutecznosc.md', label: 'Skuteczność psychoterapii',    status: 'planned' },
    ...
    psychopathology: [
      ...
      { file: 'wiki/psychopathology/objawy_ogolne.md',             label: 'Objawy ogólne (MSE)',         status: 'planned' },
      { file: 'wiki/psychopathology/zaburzenia_lekowe.md',         label: 'Zaburzenia lękowe',           status: 'planned' },
      { file: 'wiki/psychopathology/zaburzenia_nastroju.md',       label: 'Zaburzenia nastroju',         status: 'planned' },
      { file: 'wiki/psychopathology/psychozy.md',                  label: 'Psychozy i schizofrenia',     status: 'planned' },
      { file: 'wiki/psychopathology/zaburzenia_osobowosci.md',     label: 'Zaburzenia osobowości',       status: 'planned' },
      { file: 'wiki/psychopathology/trauma_ptsd.md',               label: 'Trauma i PTSD',               status: 'planned' },
      { file: 'wiki/psychopathology/zaburzenia_odzywiania.md',     label: 'Zaburzenia odżywiania',       status: 'planned' },
      { file: 'wiki/psychopathology/neurorozwojowe.md',            label: 'Zaburzenia neurorozwojowe',   status: 'planned' },
    ...
    suicidology: [
      ...
      { file: 'wiki/suicidology/epidemiologia.md',  label: 'Epidemiologia',              status: 'planned' },
      { file: 'wiki/suicidology/teorie.md',         label: 'Teorie (Joiner, IMV)',       status: 'planned' },
      { file: 'wiki/suicidology/ocena_ryzyka.md',   label: 'Ocena ryzyka (C-SSRS)',      status: 'planned' },
      { file: 'wiki/suicidology/interwencja.md',    label: 'Interwencja kryzysowa',      status: 'planned' },
      { file: 'wiki/suicidology/profilaktyka.md',   label: 'Profilaktyka (3 poziomy)',   status: 'planned' },
      { file: 'wiki/suicidology/nssi.md',           label: 'Samookaleczenia (NSSI)',     status: 'planned' },
    ...
    sexology: [
      ...
      { file: 'wiki/sexology/orientacja.md',         label: 'Orientacja seksualna',      status: 'planned' },
      { file: 'wiki/sexology/tozsamosc_plciowa.md',  label: 'Tożsamość płciowa',         status: 'planned' },
      { file: 'wiki/sexology/dysfunkcje.md',         label: 'Dysfunkcje seksualne',      status: 'planned' },
      { file: 'wiki/sexology/terapia_seksualna.md',  label: 'Terapia seksualna',         status: 'planned' },
      { file: 'wiki/sexology/trauma_seksualna.md',   label: 'Trauma seksualna',          status: 'planned' },
    ...
    artetherapy: [
      ...
      { file: 'wiki/artetherapy/art_therapy.md',   label: 'Arteterapia plastyczna', status: 'planned' },
      { file: 'wiki/artetherapy/muzykoterapia.md', label: 'Muzykoterapia',          status: 'planned' },
      { file: 'wiki/artetherapy/dmt.md',           label: 'Choreoterapia (DMT)',    status: 'planned' },
      { file: 'wiki/artetherapy/drameterapia.md',  label: 'Drameterapia',           status: 'planned' },
      { file: 'wiki/artetherapy/biblioterapia.md', label: 'Biblioterapia',          status: 'planned' },
    ...
    animaltherapy: [
      ...
      { file: 'wiki/animaltherapy/dogoterapia.md',     label: 'Dogoterapia',          status: 'planned' },
      { file: 'wiki/animaltherapy/hipoterapia.md',     label: 'Hipoterapia',          status: 'planned' },
      { file: 'wiki/animaltherapy/felinoterapia.md',   label: 'Felinoterapia',        status: 'planned' },
      { file: 'wiki/animaltherapy/aat_zastosowania.md',label: 'AAT — zastosowania',  status: 'planned' },
      { file: 'wiki/animaltherapy/etyka_aat.md',       label: 'Etyka i dobrostan',   status: 'planned' },
      { file: 'wiki/animaltherapy/mechanizmy_aat.md',  label: 'Mechanizmy AAT',      status: 'planned' },
    ],
  },
