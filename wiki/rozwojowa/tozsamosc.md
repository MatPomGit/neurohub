...
**Jean Phinney** (1989, 1992) opracowała model **wieloetapowego kształtowania tożsamości etnicznej**, analogiczny do modelu Marcii:

| Etap | Opis |
|---|---|
| **Niezbadana tożsamość etniczna** | Brak refleksji nad przynależnością etniczną |
| **Poszukiwanie / moratorium** | Eksploracja znaczenia własnej etniczności; często wyzwolona przez zderzenie z dyskryminacją |
| **Osiągnięta tożsamość etniczna** | Jasne, pozytywne poczucie tożsamości etnicznej przy zachowaniu otwartości na inne kultury |

Silna, pozytywna tożsamość etniczna jest czynnikiem ochronnym dla dobrostanu psychicznego mniejszości etnicznych i rasowych.
...
## Kryzysy tożsamości w dorosłości
...
Problemy tożsamościowe pojawiają się w kontekście wielu zaburzeń klinicznych:

| Zaburzenie | Związek z tożsamością |
|---|---|
| **BPD** | Niestabilna, fragmentaryczna tożsamość; przewlekłe poczucie pustki |
| **Depresja** | Negatywna tożsamość narracyjna; sekwencje kontaminacyjne |
| **PTSD** | Trauma dezintegruje narrację tożsamościową; „Nie wiem, kim jestem po tym, co się stało" |
| **Anoreksja** | Tożsamość silnie związana z kontrolą ciała i odżywiania |
| **Kryzys migracyjny** | Zderzenie tożsamości kulturowych; status moratoryjny po emigracji |

Terapie skoncentrowane na tożsamości (m.in. narracyjna, schematów, ACT) pomagają odbudować spójną, elastyczną narrację o sobie.
