...
## Bowlby: biologiczne korzenie więzi

**John Bowlby** (1907–1990), psychiatra dziecięcy i psychoanalityk, sformułował teorię przywiązania jako syntezę psychoanalizy, etologii i teorii systemów. Odrzucił freudowskie pojęcie „nakarmionej miłości" (miłość jako pochodna zaspokojenia popędów) na rzecz poglądu, że więź jest pierwotnym, biologicznie uwarunkowanym systemem motywacyjnym.
...
Eksperyment obejmuje serię 8 epizodów (każdy trwa 3 minuty), w których dziecko przebywa z matką, obcą dorosłą osobą i doświadcza krótkich rozstań z matką. Obserwuje się, jak dziecko:
- eksploruje otoczenie
- reaguje na odejście matki
- zachowuje się przy ponownym spotkaniu

### Cztery style przywiązania

| Styl | Symbol | Wzorzec zachowania | Strategia regulacji |
|---|---|---|---|
| **Bezpieczny** | B | Eksploruje aktywnie; wyraża dystres po rozstaniu; szuka kontaktu przy powrocie | Aktywacja systemu przywiązania, otwarta regulacja |
| **Unikający** | A | Mało dystresu; ignoruje matkę przy powrocie; pozornie samodzielny | Deaktywacja systemu przywiązania |
...
## Neuronalne mechanizmy przywiązania
...
|---|---|---|
| **Autonomiczna** (*free/autonomous*, F) | Bezpieczny (B) | Spójna, wartościująca zarówno pozytywne, jak i negatywne doświadczenia |
| **Odrzucająca** (*dismissing*, Ds) | Unikający (A) | Idealizacja lub deprecjacja; ubogie wspomnienia, brak emocji |
| **Splątana** (*preoccupied/entangled*, E) | Ambiwalentny (C) | Gniewna, pasywna lub zagubiona; nadmiar szczegółów bez narracyjnej spójności |
| **Nierozwiązana/zdezorganizowana** (*unresolved/disorganized*, U) | Zdezorganizowany (D) | Luki, dezorientacja lub irracjonalne przekonania przy omawianiu strat/traumy |

Metaanalizy (van IJzendoorn, 1995) potwierdzają międzypokoleniową transmisję przywiązania: autonomiczni rodzice mają bezpieczne dzieci z ok. 75% trafnością.

---

## Przywiązanie w dorosłych związkach romantycznych

**Hazan i Shaver** (1987) zaproponowali model miłości romantycznej jako formy przywiązania. Dorosły partner przejmuje funkcję bezpiecznej bazy; separacja wywołuje dystres analogiczny do rozstania dziecka z opiekunem.

**Bartholomew i Horowitz** (1991) rozwinęli model dwuwymiarowy:

| | Pozytywny model innych | Negatywny model innych |
|---|---|---|
| **Pozytywny model siebie** | Bezpieczne | Odrzucające |
| **Negatywny model siebie** | Lękowo-ambiwalentne | Unikająco-lękowe (przestraszone) |

Wyróżnione style różnią się w zakresie: samoujawniania, tolerancji bliskości, radzenia sobie z zazdrością i konfliktem, a także podatności na zaburzenia nastroju i lękowe.

---

## Kliniczne implikacje teorii przywiązania
...
- George, C., Kaplan, N., & Main, M. (1985). *Adult Attachment Interview*. Manuskrypt niepublikowany. University of California, Berkeley.
- Hazan, C., & Shaver, P. R. (1987). Romantic love conceptualized as an attachment process. *Journal of Personality and Social Psychology*, 52(3), 511–524.
- Main, M., & Solomon, J. (1986). Discovery of a new, insecure-disorganized/disoriented attachment pattern. W: T. B. Brazelton & M. W. Yogman (red.), *Affective Development in Infancy*. Ablex.
