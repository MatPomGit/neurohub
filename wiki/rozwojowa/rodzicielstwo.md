...
## Model Baumrind: trzy style rodzicielskie
...
| Styl | Wymagania | Responsywność | Charakterystyka |
|---|---|---|---|
| **Autorytatywny** (*authoritative*) | Wysoka | Wysoka | Jasne zasady z uzasadnieniem; dialog i negocjacja; ciepło emocjonalne |
| **Autorytarny** (*authoritarian*) | Wysoka | Niska | Bezwzględne posłuszeństwo; kary; brak wyjaśnień; „bo tak powiedziałem" |
| **Permisywny** (*permissive*) | Niska | Wysoka | Przyzwolenie; brak granic; rodzic jako przyjaciel; unikanie konfliktu |

### Rozszerzenie Maccoby i Martin (1983)
...
## Konsekwencje stylów rodzicielskich dla dziecka

Badania podłużne (Baumrind, 1989; Steinberg i in., 1992) konsekwentnie wskazują na wyższość stylu autorytatywnego:

| Styl | Wyniki u dzieci |
|---|---|
| **Autorytatywny** | Wysoka samoocena; osiągnięcia szkolne; kompetencje społeczne; internalizacja wartości |
| **Autorytarny** | Posłuszeństwo bez internalizacji; niższa samoocena; trudności w relacjach rówieśniczych |
| **Permisywny** | Trudności z odraczaniem gratyfikacji; impulsywność; problem z autorytetem |
| **Zaniedbujący** | Najgorsze wyniki we wszystkich obszarach; ryzyko zaburzeń przywiązania, depresji, zachowań antyspołecznych |

> **Uwaga kontekstualna:** Efekty stylów rodzicielskich są moderowane przez kulturę, temperament dziecka i warunki socjoekonomiczne. Steinberg i in. (1992) wykazali, że styl autorytatywny przewiduje lepsze wyniki u białych adolescentów z klasy średniej, podczas gdy wzorzec ten jest słabszy lub nieobecny w rodzinach afroamerykańskich i azjatyckich.
...
## Determinanty stylu rodzicielskiego
...
## Zagrożenia: rodzicielstwo toksyczne i maltretowanie
...
## Trendy współczesne: rodzicielstwo helikopterowe i inne

| Styl | Opis | Główne ryzyka |
|---|---|---|
...
## Interwencje i programy rodzicielskie
...
- Hoffman, M. L. (1970). Moral development. W: P. H. Mussen (red.), *Carmichael's Manual of Child Psychology* (t. 2). Wiley.
