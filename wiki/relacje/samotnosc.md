...
Robert Weiss (1973) wyróżnił dwa rodzaje samotności:

| Rodzaj | Definicja | Wynikający z braku |
|---|---|---|
...
## Skala UCLA Loneliness Scale

**UCLA Loneliness Scale** (Russell i in., 1980; wersja 3: Russell, 1996) jest najszerzej stosowanym narzędziem do pomiaru samotności:
- 20 pozycji (skala 1–4)
- Mierzy ogólne subiektywne poczucie samotności
- Wysokie właściwości psychometryczne (α > 0.90)
- Polskie adaptacje dostępne
...
Korzystanie z mediów społecznościowych jest ambiwalentne:
...
| Efekt zdrowotny | Wyniki badań |
|---|---|
| Śmiertelność | o 26–32% wyższe ryzyko przedwczesnej śmierci |
| Choroby sercowo-naczyniowe | wyższe ryzyko nadciśnienia, zawału, udaru |
| Układ immunologiczny | osłabiona odpowiedź immunologiczna |
| Zaburzenia psychiczne | depresja, lęk, demencja |
| Sen | gorsza jakość, więcej wybudzeń |

Mechanizm: chroniczna samotność aktywuje **biologiczną czujność** (hypervigilance to social threats), co prowadzi do chronicznego stanu zapalnego i dysregulacji osi HPA.

## Samotność u różnych grup

### Młodzież i młodzi dorośli
- Paradoksalnie najwyższy poziom samotności w badaniach Cigna (2020)
- Wynika z przejść życiowych (college, praca) i porównań społecznych via social media
- Cyberprzemoc i izolacja społeczna w szkole
...
- Izolacja fizyczna i stygmatyzacja społeczna

## Interwencje

### Terapia poznawczo-behawioralna (CBT)
Cacioppo i in. (2011) wykazali, że **CBT ukierunkowana na samotność** jest skuteczniejsza niż interwencje czysto społeczne. Kluczowy element: zmiana zniekształconych przekonań o intencjach innych i automatycznych negatywnych interpretacji sygnałów społecznych.

### Grupy społeczne i aktywizacja
- Grupy wolontariatu, kluby seniora, grupy zainteresowań
- Skuteczność zależy od jakości, nie ilości interakcji
