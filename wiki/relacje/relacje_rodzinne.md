...
## Teoria systemowa Murraya Bowena

Murray Bowen opracował jedną z najważniejszych teorii funkcjonowania rodziny, opartą na ośmiu pojęciach kluczowych:

### Różnicowanie się Ja (*differentiation of self*)

Zdolność do utrzymania indywidualności emocjonalnej i tożsamości w obliczu presji grupy rodzinnej. Osoby o **wysokim różnicowaniu** potrafią:
- reagować rozumowo, gdy inni są emocjonalni,
- utrzymać własne poglądy w obliczu rodzinnych oczekiwań,
- pozostawać blisko bliskich bez zlania się z nimi.

Osoby o **niskim różnicowaniu** są silnie reaktywne emocjonalnie i trudno im separować uczucia od myślenia.
...
## Cykl życia rodziny (Carter & McGoldrick)

Carter & McGoldrick (1989) zaproponowali model sześciu etapów cyklu życia rodziny, z typowymi wyzwaniami dla każdego etapu:
...
| **Opuszczanie gniazda** | Readaptacja do życia we dwoje, wejście w rolę dziadków |
| **Rodzina w późnym życiu** | Przejście ról, opieka nad starzejącymi się rodzicami, konfrontacja ze śmiercią |

---

## Rodziny funkcjonalne i dysfunkcyjne

### Cechy rodzin resilient (odpornych)

Badania Walsh (2006) wskazują na trzy kluczowe obszary:
- **Systemy przekonań**: zdolność do nadawania sensu trudnościom, nadzieja i wiara
- **Wzorce organizacji**: elastyczność, spójność, zasoby społeczne
- **Komunikacja**: otwartość, współpraca, wyrażanie uczuć i emocji

### Sygnały dysfunkcji rodzinnej
...
- **Transmisja wzorców**: schematy z rodzeństwa przenoszone do późniejszych relacji
...
## Rodziny rekonstruowane (patchworkowe)

Rodziny, w których partnerzy wnoszą dzieci z poprzednich związków, są coraz częstsze. Typowe wyzwania:

| Wyzwanie | Opis |
|----------|------|
| **Konflikty lojalnościowe** | Dziecko między biologicznym a przybranym rodzicem |
| **Hierarchia rodzeństwa** | Renegocjacja ról dzieci z różnych rodzin |
| **Dwa domy** | Różne zasady, wartości, rutyny |
| **Relacja z byłym partnerem** | „Eks" jako stały element systemu |

Kluczowe jest stopniowe budowanie więzi (nie oczekiwanie natychmiastowej miłości) i jasne granice między rolami (rodzic, ojczym/macocha).

---

## Transmisja międzypokoleniowa

Bowen wskazał, że wzorce emocjonalne i relacyjne są **transmitowane przez pokolenia**. Mechanizmy:
- Nierozwiązane konflikty rodziców „wchodzą" w relację rodzic-dziecko
