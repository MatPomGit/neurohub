...
*Neuron* to podstawowa jednostka funkcjonalna układu nerwowego. Klasyfikuje się je ze względu na kształt i funkcję:

| Typ neuronu | Cecha | Przykład |
|---|---|---|
| Jednobiegunowy | Jeden wyrostek | Neurony czuciowe korzeni grzbietowych (formy larwalne) |
| Pseudojednobiegunowy | Jedno ciało z dwoma gałęziami | Neurony zwojów korzeni grzbietowych (DRG) |
| Dwubiegunowy | Dwa wyrostki | Komórki dwubiegunowe siatkówki |
| Wielobiegunowy | Wiele dendrytów, jeden akson | Neurony ruchowe, komórki Purkinjego |

**Funkcjonalnie** wyróżnia się neurony czuciowe (aferentne), ruchowe (eferentne) i interneurony (integracja lokalna).
...
*Płyn mózgowo-rdzeniowy (CSF)* to klarowna ciecz wypełniająca komory mózgowe, przestrzeń podpajęczynówkową i kanał kręgowy. Pełni funkcje mechaniczne (amortyzacja), metaboliczne (usuwanie metabolitów), immunologiczne (transport cytokin) i diagnostyczne (badanie przy nakłuciu lędźwiowym).

**Bariera krew-mózg (BBB)** jest selektywną barierą między krwią a OUN, tworzoną przez ściśle połączone komórki śródbłonka naczyń mózgowych wspierane przez astrocyty i perycyty. Przepuszcza lipidy, O₂, CO₂, glukozę (transporter GLUT1), ale blokuje większość leków, patogenów i dużych cząsteczek. Dysfunkcja BBB wiąże się z wieloma chorobami neurologicznymi.

## Drogi nerwowe i łuk odruchowy
...
**Układ przedsionkowy** (błędnik błoniasty ucha wewnętrznego) wykrywa przyspieszenia liniowe (woreczek, łagiewka) i kątowe (kanały półkoliste). Informacje biegną do jąder przedsionkowych, móżdżku i kory.

**Propriocepcja** to percepcja pozycji i ruchu własnego ciała, oparta na wrzecionach mięśniowych (Ia, II), narządach Golgiego (Ib) i receptorach stawowych.

## Neuroprzekaźniki i farmakologia

Główne układy neuroprzekaźnikowe i ich kliniczne znaczenie w neurologii:

| Układ | Struktury | Funkcja | Choroby |
|---|---|---|---|
| Dopaminergiczny | Substancja czarna, VTA, jądra półleżące | Ruch, nagroda, uwaga | Parkinson, schizofrenia |
| Cholinergiczny | Jądro Meynerta, prążkowie | Pamięć, uwaga, ruch | Alzheimer, miastenia |
| Serotoninergiczny | Jądra szwu (raphe) | Nastrój, sen, ból | Depresja, migrena |
| Noradrenergiczny | Miejsca sinawe (locus coeruleus) | Czujność, stres | ADHD, depresja |
| Glutaminianowy | Wszechobecny | Transmisja ekscytacyjna, LTP | Udar, epilepsja |
| GABA-ergiczny | Wszechobecny | Hamowanie | Epilepsja, lęk |
...
Nawracające napady padaczkowe spowodowane nieprawidłową synchroniczną aktywnością neuronów. Podział: napady *ogniskowe* (z jednego obszaru) lub *uogólnione* (obie półkule). EEG jest kluczowym badaniem diagnostycznym. Leczenie: leki przeciwpadaczkowe (LPP), stymulacja nerwu błędnego (VNS), chirurgia padaczki.

### Choroba Parkinsona

Postępująca neurodegeneracja dopaminergicznych neuronów substancji czarnej z obecnością ciał Lewy'ego (agregaty α-synukleiny). Triada objawów: drżenie spoczynkowe, bradykinezja, sztywność. Leczenie: levodopa/karbidopa, agoniści dopaminy, głęboka stymulacja mózgu (DBS jądra niskowzgórzowego STN).

### Stwardnienie rozsiane (SM)

Autoimmunologiczne zapalenie i demielinizacja OUN. Postaci: nawracająco-remitująca (RRMS), pierwotnie postępująca (PPMS). Diagnostyka: MRI (blaszki demielinizacyjne), badanie CSF (prążki oligoklonalne), potencjały wywołane. Leczenie: immunomodulacja (interferony, natalizumab, okrelizumab).

### Choroba Alzheimera

Najczęstsza przyczyna demencji (60–70% przypadków). Patologia: złogi amyloidu β (blaszki amyloidowe) i sploty neurofibrylarne (fosforylowane białko tau). Wczesne uszkodzenie hipokampu → amnezja anterogradna. Stopniowa degeneracja kory kojarzeniowej → upośledzenie funkcji wykonawczych, języka, orientacji.

## Neurologia a psychologia kliniczna
