# Akulturacja i adaptacja kulturowa
...
Redfield, Linton i Herskovits (1936) zdefiniowali akulturację jako zmiany wynikające z ciągłego, bezpośredniego kontaktu między grupami o różnych kulturach. Berry (1997) rozszerzył tę definicję, uwzględniając poziom grupowy (*cultural level*) i poziom indywidualny (*psychological acculturation*).

### Wymiary akulturacji

Berry wyróżnia dwa kluczowe wymiary:

1. **Podtrzymanie kultury własnej** (*cultural maintenance*): Czy wartości i tożsamość kulturowa grupy pochodzenia są ważne i warte zachowania?
2. **Kontakt z kulturą dominującą** (*contact and participation*): Czy pożądane są relacje z kulturą przyjmującą i uczestnictwo w jej życiu społecznym?
...
| | Podtrzymanie kultury własnej: TAK | Podtrzymanie kultury własnej: NIE |
|---|---|---|
| **Kontakt z kulturą dominującą: TAK** | **Integracja** | **Asymilacja** |
| **Kontakt z kulturą dominującą: NIE** | **Separacja** | **Marginalizacja** |
...
Jednostka porzuca kulturę pochodzenia na rzecz pełnego przyjęcia kultury dominującej. Może być wybierana dobrowolnie lub wymuszona presją społeczną. Krótkoterminowo obniża napięcie kulturowe, lecz długoterminowo może wiązać się z utratą tożsamości i poczuciem żalu.
...
### Przejawy stresu akulturacyjnego

Stres akulturacyjny może się manifestować jako:
- **Psychologicznie**: lęk, depresja, dezorientacja tożsamościowa, obniżone poczucie własnej wartości
- **Somatycznie**: bóle głowy, problemy z układem pokarmowym, zaburzenia snu
- **Społecznie**: izolacja, konflikty rodzinne, wycofanie z życia wspólnoty

---

## Czynniki ochronne

Badania wskazują szereg zmiennych moderujących nasilenie stresu akulturacyjnego:

| Czynnik ochronny | Mechanizm działania |
|---|---|
| **Wsparcie społeczne** (współmigrantów i społeczeństwa przyjmującego) | Bufor przed dyskryminacją, źródło praktycznej pomocy |
| **Kompetencja językowa** | Ułatwia dostęp do zasobów, redukuje frustrację |
| **Strategia integracyjna** | Bicultural identity zapewnia elastyczność i poczucie zakorzenienia |
| **Przedmigracyjne zasoby psychologiczne** | Wysokie poczucie własnej skuteczności, odporność psychiczna |
| **Tolerancyjna polityka przyjmująca** (multicultural policy) | Prawne i społeczne wsparcie dla zachowania tożsamości etnicznej |
| **Silna tożsamość etniczna** | Może działać jako bufor przed dyskryminacją (Phinney, 2003) |
