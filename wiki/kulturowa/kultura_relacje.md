# Kultura a relacje interpersonalne
...
## Miłość romantyczna a aranżowane małżeństwa
...
| Kraj | % gotowych poślubić bez miłości |
|------|-------------------------------|
| Indie | 49% |
| Pakistan | 50% |
| Tajlandia | 34% |
...
## Hierarchia i szacunek w relacjach
...
- Dzieci są zachęcane do kwestionowania autorytetów
- Szef może być adresowany po imieniu
...
| Wymiar | Kultury niskokontekstowe | Kultury wysokokontekstowe |
|--------|--------------------------|--------------------------|
| **Przekaz** | Explicite, dosłowny | Implicite, symboliczny |
| **Kontekst** | Mało istotny | Kluczowy |
| **Przykłady** | USA, Niemcy, Skandynawia | Japonia, Chiny, Arabia Saudyjska |
| **Konflikt** | Otwarty, konfrontacyjny | Unikany, pośredni |
| **Relacje** | Instrumentalne, czasowe | Długotrwałe, bazujące na zaufaniu |
| **Umowy** | Formalne, pisemne | Oparte na słowie i relacji |

Hall opisał też **chronemikę** (stosunek do czasu), **proksemikę** (użycie przestrzeni) i **haptykę** (dotyk) jako wymiary kultury w relacjach interpersonalnych.
...
Kultury niskokontekstowe preferują komunikację **bezpośrednią** (*direct communication*):
- Oczekuje się jasnego wyrażenia opinii i potrzeb
- „Tak" znaczy „tak", „nie" znaczy „nie"
- Asertywność jest cnotą

### Nieporozumienia międzykulturowe

Osoba z kultury niskokontekstowej może interpretować pośredniość jako nieszczerość lub manipulację. Osoba z kultury wysokokontekstowej może odbierać bezpośredniość jako atak lub brak szacunku. Nierozumienie tych wzorców jest częstą przyczyną konfliktów w relacjach wielokulturowych i w miejscu pracy.
