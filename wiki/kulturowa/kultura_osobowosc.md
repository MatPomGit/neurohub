...
- Struktura pięcioczynnikowa replikuje się zarówno w kulturach indywidualistycznych, jak i kolektywistycznych
- Wyniki samoopisu korelują z ocenami obserwatorów niezależnie od kraju
- Taksonomia leksykalna (przymiotniki opisujące osobowość) w różnych językach konwerguje ku podobnym wymiarom
...
- **Agresja** jako odpowiedź na zniewagę jest społecznie akceptowana i oczekiwana
- Wysoka wrażliwość na **utratę twarzy** i zniewagę publiczną
- Silny kod **gościnności** i zobowiązań wobec gości
- Przemoc w obronie honoru jest postrzegana jako cnota, nie wykroczenie

### Implikacje psychologiczne

Badania Nisbetta i Cohena (1996) pokazały, że południowi Amerykanie po doświadczeniu zniewagi mieli wyższy poziom kortyzolu i testosteronu, byli bardziej skłonni do agresji i postrzegali otoczenie jako bardziej zagrażające niż ich rówieśnicy z północy USA. Kultura honoru kształtuje nie tylko normy, ale i **wzbudzalność fizjologiczną**.

---

## Kultury twarzy

W wielu kulturach Azji Wschodniej centralną rolę odgrywa pojęcie **twarzy** (*face*, *mianzi*, *mentsu*):

| Pojęcie | Opis |
|---------|------|
| **Mianzi** (chiński) | Prestiż społeczny zdobyty przez sukces i uznanie |
| **Lian** (chiński) | Moralna integralność i zaufanie ze strony innych |
| **Mentsu** (japoński) | Społeczna reputacja, honor i godność |

W kulturach twarzy zachowanie harmonii i unikanie publicznej kompromitacji motywuje zachowanie silniej niż indywidualne preferencje. Komunikacja jest pośrednia; odmowa jest maskowana; konfrontacja jest rzadka. Te wzorce mają znaczenie dla pracy grupowej, negocjacji, ale też psychoterapii i diagnostyki.

---

## Indywidualizm-kolektywizm a Wielka Piątka

Triandis i współpracownicy zestawili wymiar indywidualizm-kolektywizm z wynikami Wielkiej Piątki:

- **Ekstrawersja**: wyższe wyniki w kulturach indywidualistycznych, gdzie autoprezentacja i asertywność są wartościowane
- **Ugodowość**: wyższe wyniki w kulturach kolektywistycznych, gdzie harmonia interpersonalna jest priorytetem
- **Sumienność**: różni się w zależności od tego, czy jest rozumiana jako realizacja własnych celów (indywidualizm) czy wypełnianie obowiązków wobec grupy (kolektywizm)
- **Neurotyczność**: wyższe wyniki w kulturach o wysokim wskaźniku unikania niepewności (Hofstede)
- **Otwartość**: silnie powiązana z wykształceniem i urbanizacją, mniej jednoznacznie z wymiarem I-K
...
| Wymiar | Ja niezależne | Ja współzależne |
|--------|--------------|----------------|
| Autoprezentacja | Podkreślanie unikalnych cech | Podkreślanie przynależności |
| Motywacja | Wewnętrzna, autonomiczna | Relacyjna, oparta na normach |
| Emocje | Skupione na Ja (duma, pewność siebie) | Skupione na relacjach (wstyd, sympatia) |
| Atrybucja | Dyspozycyjna (wewnętrzna) | Sytuacyjna i relacyjna |
...
- **Konflikt kulturowy** (poczucie sprzeczności dwóch tożsamości) koreluje z dyskomfortem i problemami adaptacyjnymi
- Ekspozycja na dwie kultury zwiększa **myślenie kreatywne** i zdolność do przekraczania mentalnych kategorii
