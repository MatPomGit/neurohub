...
- **Ekstrawertycy** poszukują stymulacji (towarzystwo, przygody, hałas)
...
## Kwestionariusz EPQ i EPQ-R

**Eysenck Personality Questionnaire (EPQ)** i jego rewizja (EPQ-R, Eysenck & Eysenck, 1991) to standardowe narzędzie pomiaru trzech wymiarów PEN, zawierające dodatkowo skalę kłamstwa (L). EPQ-R ma:
- 100 pozycji (tak/nie)
- Skale: P, E, N, L
- Polskie adaptacje dostępne dla dorosłych i młodzieży

**Eysenck Personality Profiler (EPP)** to rozwinięta wersja obejmująca 21 skal podrzędnych.

## Związek PEN z Wielką Piątką (NEO)

Choć Eysenck preferował trzy czynniki, jego wymiary mają wyraźne odpowiedniki w modelu Wielkiej Piątki:
...
- Hipoteza ARAS nie uzyskała jednoznacznego potwierdzenia neuronaukowego
- Psychotyzm (P) jest konstruktem niejednorodnym i słabo odróżniającym psychozę od innych cech
- Model ignoruje interakcje czynniki temperamentalne × środowisko
- Brak uwzględnienia zmian temperamentu w ciągu życia

## Dziedzictwo Eysencka
...
- Eysenck, H. J., & Eysenck, S. B. G. (1991). *Eysenck Personality Questionnaire-Revised (EPQ-R)*. Hodder & Stoughton.
