...
## Dopasowanie temperamentu do zawodu

Koncepcja *person-environment fit* (PE fit) zakłada, że efektywność i satysfakcja z pracy są najwyższe przy **dopasowaniu cech jednostki do wymagań środowiska zawodowego**. W kontekście temperamentu kluczowe jest dopasowanie *zapotrzebowania na stymulację* (ZNS, RTT Strelaua) do stymulacyjności zawodu.

| Zawód | Stymulacyjność | Optymalny profil temperamentu |
|---|---|---|
| Chirurg, pilot, ratownik, policjant | Bardzo wysoka | niska RE, wysoka WT, wysoka ŻW |
| Menadżer, sprzedawca, nauczyciel | Wysoka | umiarkowana RE, wysoka WT |
| Programista, badacz, archiwista | Niska–umiarkowana | wysoka WS, umiarkowana WT |
| Artysta, muzyk, pisarz | Zmienna | wysoka WS, wysoka PE |
...
## Temperament a wypalenie zawodowe

*Wypalenie zawodowe* (Maslach, 1982) ma istotne korelaty temperamentalne:

| Wymiar wypalenia | Korelat temperamentalny |
|---|---|
| Wyczerpanie emocjonalne | wysoka RE, niska WT |
| Depersonalizacja | wysokie BIS, perseweratywność |
| Poczucie niskiej skuteczności | niska ŻW, wysoki neurotyzm |

Badania polskie (Strelau i Zawadzki) wykazały, że **reaktywność emocjonalna × niedopasowanie ZNS** jest silnym predyktorem wypalenia w zawodach pomocowych i służbach mundurowych.

## Temperament a style radzenia sobie ze stresem zawodowym

Strelau opisał relację między temperamentem a stylami radzenia sobie (*coping*):

- Wysoka RE + niska WT → **coping skoncentrowany na emocjach** (ruminacja, unikanie) → mniej efektywny
- Niska RE + wysoka WT → **coping zadaniowy** (aktywne rozwiązywanie problemów) → bardziej efektywny
- Wysoka perseweratywność → trudność z oderwaniem się od problemu po zakończeniu pracy
...
**FCZ-KT(R)** jest stosowany w:
- Selekcji do zawodów mundurowych (policja, wojsko, straż pożarna)
- Ocenie kandydatów na pilotów i kontrolerów ruchu lotniczego
- Doborze kadr do pracy pod presją czasu
