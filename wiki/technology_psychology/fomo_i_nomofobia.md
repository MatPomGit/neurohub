...
### 1. Podłoże motywacyjne

FOMO jest silnie powiązane z potrzebą afiliacji i statusu społecznego. Im bardziej jednostka opiera samoocenę na zewnętrznych sygnałach uznania, tym częściej monitoruje kanały społecznościowe.

### 2. Pętla lęk–sprawdzenie–ulga

W nomofobii dominują krótkie cykle: wzrost napięcia, sprawdzenie telefonu, chwilowa ulga, a następnie ponowny wzrost potrzeby kontroli. To klasyczny wzorzec negatywnego wzmocnienia, który może utrwalać zachowanie mimo świadomości kosztów.

### 3. Relacja z dobrostanem

Wysokie nasilenie FOMO i nomofobii koreluje z gorszą jakością snu, większym napięciem, trudnościami koncentracji i niższą satysfakcją z relacji offline. Wniosek interpretacyjny: to nie „samo bycie online” jest ryzykiem, lecz kompulsyjny, lękowy tryb używania.

### 4. Czynniki ochronne

Do najważniejszych należą: stabilna samoocena niezależna od reakcji społecznych, kompetencje metapoznawcze, jasne granice dostępności i wspierające normy grupowe (np. akceptacja opóźnionej odpowiedzi).
...
**Konsekwencje:** fragmentacja snu, wzrost drażliwości, pogorszenie pamięci roboczej i nasilanie lękowego stylu przywiązania do urządzenia.
