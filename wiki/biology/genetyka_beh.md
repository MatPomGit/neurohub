...
Porównanie dzieci adoptowanych z biologicznymi i adoptującymi rodzicami pozwala rozdzielić wpływ genów (korelacja z biologicznymi) od środowiska (korelacja z adopcyjnymi). Wyniki silnie potwierdzają genetyczne podłoże inteligencji i osobowości.

### Badania GWAS

**GWAS** (Genome-Wide Association Studies) szukają korelacji między milionami wariantów genetycznych (SNP) a cechami fenotypowymi. Wymagają ogromnych próbek (dziesiątki–setki tysięcy osób). Odkryte efekty są zazwyczaj małe, lecz łączone w *poligenic risk score (PRS)* mogą przewidywać ryzyko schorzenia.

> **Pułapka:** Odziedziczalność obliczona z bliźniąt bywa "brakująca" (missing heritability) — GWAS wyjaśniają mniej wariancji niż sugerują badania bliźniąt. Przyczyny to: rzadkie warianty, interakcje genotyp-środowisko, efekty epigenetyczne.

## Trzy prawa genetyki behawioralnej (Turkheimer)

Eric Turkheimer (2000) sformułował empiryczne prawa:

1. **Wszystkie cechy behawioralne są przynajmniej częściowo odziedziczalne** — nie ma cechy psychologicznej z odziedziczalnością bliską zeru
2. **Wpływ wspólnego środowiska jest mniejszy niż efekt genów** — rodzeństwo wychowane razem jest podobne głównie przez geny
3. **Znaczna część wariancji nie jest wyjaśniana ani przez geny, ani przez środowisko wspólne** — indywidualne środowisko i losowość odgrywają ogromną rolę
...
Genetyczne predyspozycje i środowisko nie działają niezależnie:
...
**Autyzm:** Odziedziczalność ~70–90%. Wiele rzadkich mutacji *de novo* (nowych, nie odziedziczonych) pełni ważną rolę.

**ADHD:** Odziedziczalność ~75%. Poligeniczny charakter; geny dopaminergiczne i noradrenergiczne.

## Implikacje etyczne

Genetyka behawioralna rodzi ważne pytania: Czy wiedza o ryzyku genetycznym może stygmatyzować? Jak łączyć determinizm genetyczny z odpowiedzialnością moralną?
