...
## Czego unikać w komunikacji pomocowej

| Nieskuteczne wzorce | Przykłady |
|---|---|
| **Dawanie rad bez pytania** | „Powinieneś zerwać z tą pracą." |
| **Trywializowanie** | „To nic wielkiego, inni mają gorzej." |
| **Moralizowanie** | „Powinieneś był pomyśleć wcześniej." |
| **Diagnostykowanie** | „Wyraźnie masz depresję." |
| **Zaprzeczanie emocjom** | „Nie powinieneś tak czuć." |
| **Zmiana tematu** | Przejście na inny temat, gdy rozmówca wyraża ból |

---

## Komunikacja werbalna i niewerbalna

Skuteczna komunikacja wspierająca angażuje oba kanały:

**Werbalny**: dobór słów, ton głosu, tempo mówienia, pauzy

**Niewerbalny**: kontakt wzrokowy, postawa ciała, mimika, gesty, dystans fizyczny

Niespójność między tymi kanałami podważa autentyczność i może dezorientować klienta.
