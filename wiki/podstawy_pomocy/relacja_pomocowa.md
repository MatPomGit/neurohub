...
## Zagrożenia i trudności w relacji

| Problem | Opis |
|---|---|
| **Przeniesienie** | Klient reaguje na pomagającego jak na ważną osobę z przeszłości |
| **Kontprzeniesienie** | Reakcje emocjonalne pomagającego wynikające z własnej historii |
| **Zależność** | Nadmierne uzależnienie klienta od relacji zamiast budowania własnych zasobów |
| **Naruszenie granic** | Przekraczanie granicy zawodowej (podwójna rola, kontakt poza sesjami) |

Regularne **superwizje** pomagają identyfikować i przepracowywać trudności pojawiające się w relacji.

---

## Relacja pomocowa a inne relacje
