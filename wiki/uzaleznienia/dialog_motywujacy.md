...
## Duch MI (*Spirit of MI*)

Zanim omówione zostaną konkretne techniki, należy podkreślić fundamentalne nastawienie terapeuty, które Miller i Rollnick (2012) określają jako **ducha MI**. Składa się on z czterech elementów:

| Element | Opis |
|---------|------|
| **Partnerstwo** (*Partnership*) | Terapeuta i klient są równorzędnymi partnerami; ekspert od własnego życia to klient |
| **Akceptacja** (*Acceptance*) | Bezwarunkowe poszanowanie autonomii, wartości i potencjału klienta |
| **Współczucie** (*Compassion*) | Aktywne promowanie dobrostanu klienta jako priorytet ponad własnymi interesami terapeuty |
| **Wywoływanie** (*Evocation*) | Zasoby i motywacja do zmiany tkwią w kliencie; zadaniem terapeuty jest je wydobyć, nie narzucić |

---

## Zasady MI: RULE i OARS
...
| Technika | Angielski termin | Zastosowanie |
|----------|-----------------|--------------|
| **Pytania otwarte** | Open questions | Zachęcają do rozwinięcia; „Co sprawiło, że zdecydował się Pan dzisiaj tu przyjść?" |
| **Afirmacje** | Affirmations | Uznanie mocnych stron i wysiłków klienta |
| **Refleksje** | Reflective listening | Parafraza, odzwierciedlenie, refleksja rozszerzona |
| **Podsumowania** | Summaries | Zbierają kluczowe wątki; przygotowują grunt pod zmianę |

---

## Mowa zmiany i mowa podtrzymania
...
## Transteoretyczny model zmiany (Prochaska i DiClemente)

Dialog motywujący jest często stosowany w połączeniu z **transteoretycznym modelem zmiany** (*Transtheoretical Model*, TTM) opracowanym przez Jamesa Prochaską i Carlo DiClemente (1983). Model zakłada, że zmiana zachowania przebiega przez sekwencję **stadiów**:
...
| **Nawrót** | Powrót do poprzedniego zachowania | Normalizacja, wyciąganie wniosków |

> **Uwaga:** TTM bywa krytykowany za sztuczność granic między stadiami (West, 2005), jednak jako metafora kliniczna pozostaje niezwykle przydatny.

---

## Techniki praktyczne

### Bilans decyzyjny (*Decisional balance*)

Terapeuta wspólnie z klientem eksploruje cztery pola:

|  | Zmiana | Brak zmiany |
|--|--------|-------------|
| **Plusy** | Korzyści ze zmiany | Korzyści z pozostania |
| **Minusy** | Koszty zmiany | Koszty pozostania |
...
Terapeuta pomaga klientowi dostrzec przepaść między obecnym zachowaniem a deklarowanymi wartościami: „Mówi Pan, że rodzina jest najważniejsza. Jak picie wpływa na Pana rolę ojca?"

### Toczenie się z oporem (*Rolling with resistance*)

Zamiast konfrontacji, terapeuta odzwierciedla i odkształca opór: „Słyszę, że nie jesteś pewien, czy masz problem. Co inni dostrzegają w Twoim piciu?"
...
- Miller, W. R., & Rollnick, S. (2012). *Motivational Interviewing: Helping People Change* (3rd ed.). Guilford Press. [Wyd. pol.: Dialog motywujący. Jak pomóc ludziom w zmianie. WUJ, 2014]
