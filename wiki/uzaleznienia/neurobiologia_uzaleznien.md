...
## Układ nagrody i szlak dopaminowy

### Mezolimbiczny szlak dopaminowy
...
## Neuroplastyczność w uzależnieniach

Długotrwałe używanie substancji powoduje **trwałe zmiany strukturalne i funkcjonalne** w mózgu:
...
## Model choroby mózgu (Volkow, Koob)

Nora Volkow i George Koob rozwinęli **neurobiologiczny model choroby uzależnienia**, wyróżniając trzy etapy cyklu uzależnienia:

### 1. Binge/Intoxication (użycie/zatrucie)

- Gwałtowna aktywacja NAcc i szlaków dopaminowych
- Intensywna nagroda i uczenie się środowiskowych cues
...
- Silna aktywacja cue-reaktywności w OFC i ACC
- Osłabiona kontrola PFC
- Craving i nawrót

Model ten stanowi podstawę dla farmakoterapii:
- Etap 1 → antagoniści receptorów opioidowych (naltrekson), leki zmniejszające nagradzanie
- Etap 2 → leki antydepresyjne, antykonwulsyjne, redukcja stresu
- Etap 3 → leki obniżające craving (akamprozat, buprenorfina)

---

## Czynniki ryzyka neurobiologicznego
