...
## Role rodzinne w systemie uzależnienia

Sharon Wegscheider-Cruse opisała charakterystyczne **role przystosowawcze**, które przyjmują członkowie rodziny osoby uzależnionej:
...
Używa humoru i rozśmieszania do rozładowywania napięcia. Jego śmiech skrywa lęk i ból. Jako dorosły często ma trudności z powagą, z dopuszczaniem negatywnych emocji.
...
|------|--------------------|----------------------|
| Bohater | Przywrócenie rodzinie godności | Perfekcjonizm, wypalenie |
| Kozioł | Skupienie problemu poza uzależnionym | Izolacja, problemy z prawem |
| Maskotka | Rozładowanie napięcia | Ukryty lęk, brak dojrzałości emocjonalnej |
| Zagubione dziecko | Zmniejszenie obciążenia | Samotność, dysocjacja |
...
- Nadmierne skupienie na potrzebach i zachowaniu partnera kosztem własnych
- Ratowanie, kontrolowanie i usprawiedliwianie osoby uzależnionej (*enabling*)
- Trudności z wyznaczaniem granic
- Lęk przed porzuceniem i zależność relacyjna
...
- Dzwonienie w jej imieniu do pracodawcy z wymówkami
- Ukrywanie butelek lub śladów używania
- Nieegzekwowanie wcześniej ustalonych granic

Enabling blokuje „uderzenie dna" (*hitting bottom*), które często jest punktem zwrotnym motywacji do leczenia.

---

## Dzieci z rodzin z problemem alkoholowym (DDA)

**Dorosłe Dzieci Alkoholików** (*Adult Children of Alcoholics*, DDA/ACA) to osoby, które dorastały w rodzinie z problemem alkoholowym. Bez interwencji terapeutycznej przenoszą wzorce z rodziny generacyjnej:
...
Oparty na dowodach program uczący rodzin, jak **nieinterwencyjnie** wspierać wchodzenie do leczenia. W przeciwieństwie do konfrontacyjnych interwencji:
- Uczy pozytywnego wzmacniania zachowań abstynencyjnych
- Uczy redukowania umożliwiania (*enabling*)
- Zmniejsza depresję i lęk u bliskich osoby uzależnionej

Badania Miller i współpracowników: CRAFT osiągało 64–74% wskaźnik wejścia do leczenia vs 30% dla Al-Anon i interwencji konfrontacyjnej.

#### Systemowa terapia rodzinna

Praca z całą rodziną jako systemem; identyfikowanie wzorców komunikacji, granic i ról podtrzymujących uzależnienie.

#### Interwencja rodzinna (Johnson Intervention)

Tradycyjna metoda konfrontacyjna; jej skuteczność jest mniejsza niż CRAFT, lecz ma wartość mobilizowania rodziny do działania.
