...
### Sekwencja prowadząca do nawrotu

```
Sytuacja wysokiego ryzyka
        ↓
Brak skutecznej strategii radzenia sobie
        ↓
Zmniejszenie self-efficacy + wzrost oczekiwań pozytywnych wobec substancji
        ↓
Pierwsze użycie (lapse)
        ↓
Efekt naruszenia abstynencji (AVE) → poczucie winy, dysatrybucja wewnętrzna
        ↓
...
Marlatt i Gordon skategoryzowali sytuacje wysokiego ryzyka na podstawie analizy nawrotów u osób uzależnionych od alkoholu, heroiny i papierosów:

| Kategoria | Przykłady | Częstość* |
|-----------|-----------|-----------|
| Negatywne stany emocjonalne | gniew, lęk, depresja, nuda | ~35% |
| Konflikty interpersonalne | kłótnie z partnerem, szefem | ~16% |
| Presja społeczna | bezpośrednia lub pośrednia | ~20% |
| Pozytywne stany emocjonalne | świętowanie, euforia | ~12% |
| Inne (ból, głód, środowisko) | widok butelki, zapachy | ~17% |

*\*Dane przybliżone na podstawie: Marlatt & Gordon, 1985*

---

## Kluczowe interwencje poznawczo-behawioralne

### 1. Identyfikacja wyzwalaczy (*trigger identification*)

Klient i terapeuta wspólnie mapują **zewnętrzne** (miejsca, osoby, sytuacje) i **wewnętrzne** (myśli, emocje, stany fizyczne) wyzwalacze głodu i nawrotu. Narzędziem jest **dziennik głodu** oraz techniki wywiadu funkcjonalnego (*functional analysis*).
...
Identyfikacja i podważanie myśli wysokiego ryzyka: „Jedna lampka nie zaszkodzi", „Zasłużyłem na relaks", „I tak jestem beznadziejny".

### 5. Plan awaryjny (*emergency plan*)

Klient przygotowuje konkretny plan działania na wypadek kryzysu: numery telefonów zaufanych osób, lista technik radzenia sobie, instrukcja krok po kroku.

---

## Efekt naruszenia abstynencji (AVE)
...
| Badanie | Główne wyniki |
|---------|--------------|
| Carroll (1996) | CBT-RP skuteczne szczególnie w dłuższej perspektywie (efekty rosną po zakończeniu terapii) |
| Irvin i in. (1999) | Meta-analiza 26 badań: RP skuteczniejsze od kontroli dla alkoholu i polinarkomanii |
| Marlatt & Donovan (2005) | Przegląd kliniczny potwierdza efektywność składowych RP w leczeniu różnych uzależnień |
| Bowen i in. (2014) | MBRP przewyższa tradycyjne RP w długoterminowym utrzymaniu trzeźwości |

---

## Ograniczenia modelu

Krytyki modelu Marlatta obejmują:
