...
Oparte na tych samych zasadach, NA rozszerzyły podejście na wszystkie substancje, akcentując „żadnych środków zmieniających świadomość".
...
## SMART Recovery jako alternatywa

**SMART Recovery** (*Self-Management and Recovery Training*) to program oparty na CBT i terapii racjonalno-emotywnej (REBT), oferowany jako świecka, niespiritualna alternatywa dla 12 kroków.
...
## Grupy CBT w uzależnieniach

Grupowe podejście **poznawczo-behawioralne** (*CBT groups*) koncentruje się na:
...
## Czynniki leczące Yaloma w kontekście uzależnień

Irvin Yalom zidentyfikował **11 czynników leczących** w psychoterapii grupowej. W kontekście uzależnień szczególne znaczenie mają:
...
| **Spójność grupowa** | Poczucie przynależności i bezpieczeństwa |
| **Katharsis** | Wyrażenie emocji i uzyskanie ulgi |

---

## Terapia skoncentrowana na rozwiązaniach (SFA) w grupach

**Terapia skoncentrowana na rozwiązaniach** (*Solution-Focused Approach*, SFA) koncentruje się na zasobach i wyjątkach od problemu, nie na jego przyczynach:
...
Program dla nastolatków wychowywanych w rodzinach z problemem alkoholowym. Rówieśnicze wsparcie i budowanie tożsamości niezależnej od roli rodzinnej.
...
## Format i organizacja grup terapeutycznych

| Wymiar | Grupy 12-kroków | Grupy CBT | SMART Recovery |
|--------|----------------|-----------|----------------|
| Czas trwania | Bezterminowo | 12–20 sesji | Bezterminowo / cykl |
| Terapeuta | Brak (peer-led) | Terapeuta prowadzi | Facylitator lub peer |
| Orientacja | Duchowa/wspólnotowa | Psychoedukacyjna | Kognitywna/behawioralna |
| Abstynencja | Wymagana lub cel | Cel terapii | Flexibilna (harm reduction) |
