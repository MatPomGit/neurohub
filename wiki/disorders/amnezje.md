...
Mechanizm amnezji anterogradnej polega na zaburzeniu **konsolidacji pamięci** — procesu stabilizowania śladu pamięciowego z krótkotrwałej do długotrwałej formy. Wyróżnia się konsolidację **synaptyczną** (godziny — stabilizacja molekularna synaps) i **systemową** (tygodnie–lata — reorganizacja śladu z hipokampa do kory).
...
**Fuga dysocjacyjna** — amnezja połączona z niezamierzonymi wędrówkami i przyjęciem nowej tożsamości. Pacjent może „obudzić się" w nowym mieście bez pamięci, jak się tam znalazł.

**Dysocjacyjne zaburzenie tożsamości (DID)** — dawniej osobowość mnoga. Obecność co najmniej dwóch odrębnych stanów osobowości z wzajemną amnezją.
...
Niedobór tiaminy powoduje zmiany metaboliczne przede wszystkim w strukturach zależnych od wysokiego metabolizmu glukozy: **ciała suteczkowate** (mammillary bodies), **wzgórze** (szczególnie jądro grzbietowo-przyśrodkowe), **kora móżdżku** i obszary okołowodociągowe.

**Triada objawów Korsakoffa**: głęboka amnezja następcza (anterogradna), **konfabulacja** (nieświadome wymyślanie odpowiedzi na pytania o to, czego się nie pamięta — bez intencji kłamstwa) oraz **ataksja** i zaburzenia okoruchowe.

Poprzedza go często **encefalopatia Wernickego** — ostra postać niedoboru tiaminy z triadą: encefalopatia (splątanie), zaburzenia okoruchowe (oczopląs, oftalmoplegia) i ataksja. Nieleczona prowadzi do nieodwracalnego zespołu Korsakoffa.
...
Ocena amnezji wymaga systematycznego badania różnych komponentów pamięci:

- **Testy pamięci werbalnej**: California Verbal Learning Test (CVLT), Rey Auditory Verbal Learning Test (RAVLT) — krzywe uczenia, wolne i wspomagane przypominanie, rozpoznawanie.
- **Pamięć wzrokowa**: Rey Complex Figure Test (odroczone odtworzenie), Brief Visuospatial Memory Test.
- **Pamięć proceduralna**: zadania motoryczne (Serial Reaction Time), zadania torowania (priming).
- **Pamięć autobiograficzna**: Autobiographical Memory Interview (AMI).
