...
## Czym jest superwizja w kontekście etycznym?

W rozumieniu etycznym superwizja to nie tylko narzędzie rozwojowe, ale **zobowiązanie zawodowe**. Kodeksy etyczne (APA Standard 2.05, Kodeks PTP §12) wprost wskazują, że psycholog powinien:

- **znać granice własnych kompetencji** i nie podejmować przypadków przekraczających jego kwalifikacje
- **szukać superwizji lub konsultacji** zawsze, gdy wymaga tego dobro klienta lub trudność przypadku
- **zapewniać superwizję** podwładnym i stażystom, za których pracę ponosi odpowiedzialność

Superwizja jest zatem zarówno prawem psychologa (do wsparcia), jak i jego obowiązkiem (wobec klientów, stażystów i profesji).

---

## Rodzaje odpowiedzialności zawodowej

### 1. Odpowiedzialność etyczna

Regulowana przez kodeksy towarzystw zawodowych (PTP, APA, EFPA). Naruszenie kodeksu może skutkować:

- **upomnieniem** lub **naganą** od komisji etycznej
- **zawieszeniem członkostwa** w towarzystwie
- **wykluczeniem** ze stowarzyszenia zawodowego

Postępowania etyczne wszczynane są na wniosek klienta, innego psychologa lub z inicjatywy własnej komisji. Procedura obejmuje wyjaśnienia obwinionego, zbieranie dowodów i decyzję komisji z możliwością odwołania.
...
Psycholog może ponosić odpowiedzialność cywilną za **szkodę wyrządzoną klientowi** (majątkową lub niemajątkową), jeśli:
...
Dotyczy najpoważniejszych naruszeń, np. ujawnienia tajemnicy zawodowej bez podstawy prawnej (art. 266 KK), nadużycia seksualnego, wyłudzenia czy fałszowania dokumentacji medycznej.

---

## Superwizja jako narzędzie zarządzania ryzykiem etycznym

Superwizja regularnie podejmuje tematy z obszaru etyki, m.in.:

| Sytuacja | Funkcja superwizji |
|---|---|
| Silne przeniesienie lub przeciwprzeniesienie | Utrzymanie granic; zapobieganie naruszeniom |
| Przypadki graniczne (suicydalność, przemoc) | Podejmowanie decyzji o ujawnieniu tajemnicy |
| Klienci nieletnii | Kwestia zgody, ochrony dziecka, relacji z rodzicami |
| Konflikty interesów | Identyfikacja podwójnych ról |
| Wypalenie zawodowe superwizanta | Ocena zdolności do pracy, obowiązek samooceny |
| Dilematy wartości | Klauzula sumienia, wartości kulturowe klienta vs. normy etyczne |
...
Superwizor może ponosić **odpowiedzialność zastępczą** (*vicarious liability*) za błędy superwizanta, jeśli:

- wiedział lub powinien był wiedzieć o problemie i nie interweniował
- nie zapewnił odpowiedniej częstotliwości i jakości superwizji
- zlecił superwizantowi zadania przekraczające jego kompetencje

---

## Obowiązki psychologa wobec siebie jako element odpowiedzialności
...
## Dokumentacja jako element odpowiedzialności
