...
### Wymogi RODO dla psychologów online

| Obszar | Wymóg |
|---|---|
| **Platforma wideokonferencji** | Szyfrowanie end-to-end, serwery w EOG lub odpowiedni transfer danych |
| **Dokumentacja kliniczna** | Szyfrowanie, kontrola dostępu, kopia zapasowa |
| **Komunikacja z klientem** | Szyfrowane kanały (nie zwykłe SMS czy e-mail bez szyfrowania) |
| **Zgoda elektroniczna** | Dokument z jednoznaczną zgodą, przechowywany weryfikowalnie |
| **Naruszenie danych** | Obowiązek zgłoszenia do UODO w ciągu 72 godzin |
...
### Specyfika videokonferencji

Relacja terapeutyczna przez ekran różni się od kontaktu bezpośredniego:
...
| **Terapeutyczna obecność** | Naturalna | Wymaga aktywnego budowania |
...
- Chatboty terapeutyczne (Woebot, Wysa)
- Algorytmy skriningowe depresji i ryzyka suicydalnego
- Analiza tekstu i mowy pod kątem wskaźników klinicznych
- Wspomaganie diagnozy z nagrań wideo (mikroekspresje, ASD)
...
### Zasady etyczne dla AI w psychologii (wg APA, 2021)

1. AI jest narzędziem wspomagającym, nie zastępującym osąd kliniczny
2. Psycholog pozostaje odpowiedzialny za decyzje kliniczne
3. Klient musi wiedzieć, gdy używane są narzędzia AI
4. Dane klientów nie mogą być wykorzystywane do trenowania modeli bez zgody

## Anonimowość online a psychoterapia
...
## Platformy komercyjne vs. profesjonalne
