...
## Główne kodeksy etyczne

### 1. Kodeks APA (Stany Zjednoczone)

**American Psychological Association Ethics Code** (aktualna wersja: 2017) jest najszerzej cytowanym kodeksem na świecie. Struktura:

| Część | Zawartość |
|---|---|
| **Preambuła** | Misja APA i zobowiązanie do etycznego postępowania |
| **Zasady ogólne (A–E)** | Aspiracyjne wartości: dobroczynność, wierność, integralność, sprawiedliwość, szacunek |
...
- **Unikania szkodliwych podwójnych ról** (3.05)
- **Kompetencji zawodowej** (2.01–2.06)
...
### 3. Kodeks EFPA (Europa)

**European Federation of Psychologists' Associations Meta-Code of Ethics** (2005, aktualizacja 2015) jest ramowym dokumentem nadrzędnym dla stowarzyszeń krajów europejskich. Wyróżnia cztery zasady:

| Zasada | Treść |
|---|---|
| **Szacunek dla praw i godności osoby** | Autonomia, prywatność, poufność, zgoda |
| **Kompetencja** | Wiedza, umiejętności, granice kompetencji, doskonalenie |
...
## Porównanie strukturalne kodeksów

| Cecha | APA | PTP | EFPA |
|---|---|---|---|
| Zasady ogólne | 5 (A–E) | 4 obszary | 4 zasady |
| Standardy egzekwowalne | Tak (1–10) | Tak | Nie (meta-kodeks) |
| Komisja dyscyplinarna | Tak | Tak | Nie |
| Regulacja badań | Tak (8) | Tak | Pośrednio |
| Regulacja diagnostyki | Tak (9) | Tak | Pośrednio |
| Aktualizacja | 2017 | 2018 | 2015 |
...
Prawo krajowe (Ustawa o zawodzie psychologa 2001, RODO)
        ↓
Kodeksy etyczne towarzystw zawodowych (PTP, EFPA)
        ↓
Wewnętrzne regulaminy instytucji (szpital, szkoła, gabinet)
        ↓
Osobisty osąd moralny psychologa
```

Zasada **minimalna**: psycholog zawsze postępuje zgodnie z prawem. Zasada **docelowa**: psycholog dąży do działania zgodnego z najwyższymi standardami etycznymi, które mogą być bardziej wymagające niż samo prawo.
