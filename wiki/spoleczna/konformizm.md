...
| Rodzaj | Mechanizm | Zmiana wewnętrzna? | Przykład |
|---|---|---|---|
| **Uleganie** (*compliance*) | publiczne dostosowanie bez zmiany przekonań | NIE | głosowanie zgodnie z grupą, mimo innego zdania |
| **Internalizacja** (*internalization*) | zmiana prywatnych przekonań | TAK | przyjęcie wartości grupy jako własnych |
| **Identyfikacja** (*identification*) | zmiana z powodu związku z grupą | CZĘŚCIOWO | naśladownictwo idola |

## Eksperymenty Ascha (1951–1956)

Solomon Asch zaprojektował elegancki eksperyment, by zbadać, czy ludzie będą zaprzeczać oczywistej prawdzie pod naciskiem grupy.
...
- W kontroli (bez nacisku grupy) błędy niemal nie występowały (<1%)
- Pod naciskiem grupy badani zgadzali się z błędną odpowiedzią w **37% prób**
- **75%** badanych co najmniej raz uległo konformizmowi
- Tylko **25%** nigdy nie uległo
...
## Eksperymenty Milgrama (1960–1963)

Stanley Milgram zadał pytanie: jak daleko posunie się zwykły człowiek w posłuszeństwie autorytarzowi, jeśli autorytet nakazuje skrzywdzić inną osobę?
...
|---|---|
| Podstawowy (głos przez ścianę) | 65% |
| Badany w tym samym pokoju co ofiara | 40% |
| Badany trzyma rękę ofiary na płytce | 30% |
| Dwóch buntujących się współpracowników | 10% |
| Autorytet przez telefon (nie w sali) | 21% |
...
- Wyznaczenie adwokata diabła
- Zewnętrzni eksperci zapraszani na dyskusje
