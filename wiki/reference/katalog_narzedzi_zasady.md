...
- `data/psychometric-tools/`
- każdy wpis narzędzia to **osobny plik JSON** (`<domain>/<tool_id>.json`),
- indeks domen i dat aktualizacji: `data/psychometric-tools/index.json`.

Przykład:

- `data/psychometric-tools/psychometrics/bdi_ii.json`
- `data/psychometric-tools/neuro/stroop.json`
