...
### Plan pracy z terminami

Praca magisterska to projekt rozciągnięty na dwa semestry. Podziel go na mierzalne milestones:

| Etap | Szacunkowy czas |
|------|----------------|
| Wybór tematu i promotora | Miesiąc 1 |
| Przegląd literatury + plan teoretyczny | Miesiąc 2–3 |
| Projekt badania + formularz etyczny | Miesiąc 3–4 |
| Zbieranie danych | Miesiąc 4–6 |
| Analiza danych | Miesiąc 6–7 |
| Pisanie rozdziałów | Miesiąc 5–9 |
| Korekta, formatowanie | Miesiąc 9–10 |
| Złożenie pracy | Miesiąc 10 |
| Obrona | Miesiąc 11–12 |
...
- Cytuj **źródła pierwotne**, a nie prace, które je cytują (*nie cytuj* wtórnie, jeśli możesz dotrzeć do oryginału)
- Nie cytuj Wikipedii, portali popularnonaukowych ani blogów jako źródeł naukowych
- Upewnij się, że każda pozycja w bibliografii jest faktycznie cytowana w tekście
