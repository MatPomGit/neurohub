...
Badania wykazują, że już 15–20 minut kontaktu z przyjaznym psem obniża poziom kortyzolu w ślinie i osoczu, zmniejsza tętno i ciśnienie krwi.
...
- Zmniejszeniu przewodnictwa skórnego (EDA)

Te efekty są szczególnie wyraźne u osób o chronicznej nadaktywności współczulnej (lęk, PTSD, przewlekły stres).
...
W terapiach ukierunkowanych (EAGALA, relacyjna terapia z koniem) relacja pacjenta ze zwierzęciem jest polem do eksploracji wzorców relacyjnych:

- Jak pacjent zarządza granicami z psem? (kontrola, nadopiekuńczość, uległość)
- Jak reaguje, gdy koń "nie słucha"? (frustracja, eskalacja, elastyczność)
- Co robi, gdy pies się boi? (empatia, ignorowanie, naśladowanie)

Te interakcje często odzwierciedlają utrwalone wzorce z relacjami z ludźmi i mogą być przepracowywane terapeutycznie w bezpieczniejszym kontekście.

### Sprawczość i kompetencja

Skuteczne wydanie komendy psu, opanowanie konia czy pielęgnacja zwierzęcia buduje poczucie własnej skuteczności (self-efficacy). Dla pacjentów z obniżonym poczuciem sprawstwa (depresja, trauma, niepełnosprawność) jest to doświadczenie korekcyjne.
...
### Poczucie sensu przez opiekę

Opiekowanie się żywą istotą daje poczucie celu i odpowiedzialności. U osób z depresją lub kryzysem egzystencjalnym (np. w terminalnej chorobie) relacja z psem może być jednym z nielicznych źródeł sensu i motywacji.
