...
4. Integracja danych (triangulacja jakościowa + ilościowa).
5. Translacja wyniku na decyzję (co wdrożyć, co odrzucić, co przetestować ponownie).

### 2) Psycholog jako „red team” dla błędów poznawczych

W zespołach produktowych częste są: efekt potwierdzenia, zakotwiczenie i selektywna interpretacja metryk. Psycholog pełni funkcję metodologicznego bezpiecznika: pyta o alternatywne wyjaśnienia, moc dowodów i granice wnioskowania.
