...
## Główne techniki projekcyjne

### 1. Test Rorschacha (1921)
...
- Lokalizacja: całość (W), szczegół (D, Dd)
- Treść: ludzie (H), zwierzęta (A), anatomia (An), seks (Sx)
- Wskaźniki specjalne: WSUM6, PTI (wskaźnik zaburzeń myślenia), D-score (kontrola stresu)

**Zastosowanie**: różnicowanie zaburzeń myślenia (psychoza vs. zaburzenia dysocjacyjne), ocena narcyzmu, wzorców relacyjnych, regulacji emocji.

---

### 2. Test Apercepcji Tematycznej (TAT, Murray, 1935)
...
### 4. Techniki uzupełniania zdań (SSCT, Rotter)

**Materiał**: Niedokończone zdania: „Moja matka…", „Boję się…", „Kiedy jestem sam…"
...
### 5. Zondiego Test Popędów (Test Szondi)

Mniej powszechny; oparty na wyborze twarzy – osoba wybiera najbardziej i najmniej lubiane fotografie osób z różnymi diagnozami. Interpretacja w kategoriach popędów (Szondi). Słabe wsparcie empiryczne.

---

## Teorie leżące u podstaw
...
| Obszar | Technika | Zastosowanie |
|---|---|---|
| Zaburzenia psychotyczne | Rorschach (PTI) | Ocena zaburzeń myślenia, percepcji |
| Zaburzenia osobowości | Rorschach, TAT/SCORS | Wzorce relacyjne, narcyzm, BPD |
| Trauma | TAT, SCORS | Wewnętrzne reprezentacje relacji |
| Praca z dziećmi | HTP, KFD, Rysunki | Sytuacja rodzinna, lęki, poczucie własnej wartości |
| Orzecznictwo | Rorschach (R-PAS) | Ocena w postępowaniach sądowych (ostrożność!) |
